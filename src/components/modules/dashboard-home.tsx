  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {modules.map((module) => (
          <Link
            className="shine-card rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-soft transition hover:-translate-y-1 hover:border-skybrand-300 hover:shadow-glow"
            href={module.href}
            key={module.href}
          >
            ...
            <h2 className="mt-3 font-display font-extrabold text-navy-950">
              {module.title}
            </h2>
