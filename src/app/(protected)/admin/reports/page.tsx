...
export default async function AdminReportsPage() {
  ...
  const [yearResult, sectionResult, learnerResult, exportResult] =
    await Promise.all([
      supabase
        .from("school_years")
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {[
          ["Report types", reportOptions.length],
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Filters are optional; exports use records visible to your admin
              account.
            </p>
          </div>
        </div>
